...
# Render's internal forwarded address is HTTP.  Set the public HTTPS address
# explicitly so Laravel emits secure links for the stylesheet and images.
export APP_URL="https://irongym-fj53.onrender.com"
