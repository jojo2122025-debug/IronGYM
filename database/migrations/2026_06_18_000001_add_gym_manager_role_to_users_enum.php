...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("CREATE TABLE users_new (
            ...
            role VARCHAR NOT NULL CHECK (role IN ('مدير النظام', 'مدير الصالة', 'موظف الاستقبال', 'المحاسب', 'المدقق المالي', 'مدرب', 'مشترك')),
    ...
    public function down(): void
    {
        ...
        DB::statement('DROP INDEX IF EXISTS users_old_username_unique');
        ...
        DB::statement("INSERT INTO users_old (id, username, password, name, role, member_id, created_at)
            SELECT id, username, password, name,
                CASE WHEN role = 'مدير الصالة' THEN 'مدير النظام' ELSE role END,
